...
export const createFichaTecnica = async (ficha) => ({ id_ficha: Date.now(), ...ficha });
export const updateFichaTecnica = async (id_ficha, ficha) => ({ id_ficha, ...ficha });
export const deleteFichaTecnica = async (id_ficha) => true;
